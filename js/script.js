...
btn[0].style.background = "DarkBlue"
btn[0].style.padding = "10px 25px"
btn[0].style.borderRadius = "5px"
btn[0].style.border = "none"
btn[0].style.margin = "40px 20px 0 20px"
btn[0].style.color = "white"

btn[1].style.background = "DarkRed"
btn[1].style.padding = "10px 25px"
btn[1].style.borderRadius = "5px"
btn[1].style.border = "none"
btn[1].style.margin = "40px 20px 0 20px"
